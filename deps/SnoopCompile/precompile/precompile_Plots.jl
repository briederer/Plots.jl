...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(plot)),NamedTuple{(:title,), Tuple{String}},typeof(plot),Vector{Float64}})
    ...
    Base.precompile(Tuple{typeof(expand_extrema!),Axis,Surface{Matrix{Float64}}})
    ...
    isdefined(Plots, Symbol("#179#180")) && Base.precompile(Tuple{getfield(Plots, Symbol("#179#180")),Tuple{Int64, Symbol}})
